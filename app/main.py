...
from app.common.context import _Context, get_context, init_context
from app.common.logger import info, init_root_logger
...
def main(ctx: _Context, args: Namespace):
    ...
    info(
        f"Determining execution mode from arguments 'channel_id': '{channel_id}' | 'scrape_mode': '{scrape_mode}' | 'download_mode: '{download_mode}'"
    )
    channels_to_handle = []
